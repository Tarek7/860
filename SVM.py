...
from stats import compute_acc_SVM as compute_acc
...
def gradient_comp(x, y, lamb, i, w):
	x_i = x[i,:]
	y_i = y[i]
	gradient = float(y_i) * x_i * ((y_i * np.dot(x_i, w)) <= 1)
	return gradient
...
if __name__ == '__main__':
	...
	plt.plot(x, train_accuracies_GD, 'r--', test_accuracies_GD, 'r', train_accuracies_cyc, 'k--', test_accuracies_cyc, 'k')
